...
<?php
    ...
    $Cssn=$_POST['Cssn'];
        ...
        $sql="SELECT * FROM newcovid19db.patients,newcovid19db.citizens,newcovid19db.patients_details where Hospname='대구병원 'AND patients.Cssn=citizens.ssn AND patients_details.Hcode=patients.Hcode AND Cssn='$Cssn'";
    ...
    <BODY>
        <h1>회원 정보 수정</h1>
        <FORM METHOD="post" ACTION="new_dg_hospital_patients_update_result.php">
