...
<html lang="ko">
  ...
  <body>
    ...
    <?php
            ...
            if ($result['Dept'] == "government"||$result['Dept'] == "moderna"){
        ...
        <tbody>
            <?php
                ...
                $cnt_vac = "SELECT count(*) FROM vaccines LEFT OUTER JOIN vaccinate ON (vaccines.SerialNo = vaccinate.1st_Vno OR vaccines.SerialNo = vaccinate.2nd_Vno)
                            WHERE MfgCo = 'moderna' AND MfgDate <= CURDATE() AND Exp >= CURDATE() AND (1st_date IS NULL AND 2nd_date IS NULL)"; // 접속 연결자, sql문
    ...
    <table border=1>
        ...
        <tbody>
            <?php
                ...
                WHERE vaccines.MfgCo = 'moderna' AND vaccines.MfgDate <= CURDATE() AND vaccines.Exp >= CURDATE() AND (1st_date IS NULL AND 2nd_date IS NULL)";
                ...
                while($row = mysqli_fetch_array($jb_result)){
                    ...
                    echo "<TD>
                        <form action='Moderna_edit2.php' method='POST'>
                    ...
                    echo "<TD>
                        <form action='Moderna_delete.php' method='POST'>
                            <input type='hidden' name='SerialNo' value='$row[SerialNo]'/>
                            <input type='hidden' name='uid' value='$username'/>
    ...
    <table border=1>
        ...
        <tbody>
            <?php
                $jb_conn = mysqli_connect("localhost", "root", "1234", "newcovid19db") or die("Error!!:: Covid-19 DataBase 접속 실패!!");
                //$cnt_vac = "SELECT count(*) FROM VACCINES WHERE MfgCo = 'moderna' AND MfgDate <= CURDATE()
                ...
                $cnt_vac = "SELECT count(*) FROM VACCINES, VACCINATE
                            WHERE MfgCo = 'moderna' AND MfgDate <= CURDATE() AND (VACCINES.SerialNo = VACCINATE.1st_Vno OR VACCINES.SerialNo = VACCINATE.2nd_Vno)";
                $jb_result = mysqli_query( $jb_conn, $cnt_vac );
                $vac0 = mysqli_fetch_array($jb_result);
    ...
    <table border=1>
        ...
        <tbody>
            <?php
                ...
                WHERE vaccines.MfgCo = 'moderna' AND MfgDate <= CURDATE() AND (vaccines.SerialNo = vaccinate.1st_Vno OR vaccines.SerialNo = vaccinate.2nd_Vno)";
                $jb_result = mysqli_query( $jb_conn, $jb_sql );
                ...
                while($row = mysqli_fetch_array($jb_result)){
                    ...
                    echo "<TD>", $date, "</TD>";
                    echo "<TD>
                        <form action='Moderna_edit.php' method='POST'>
                            <input type='hidden' name='SerialNo' value='$row[SerialNo]'/>
                            <input type='hidden' name='MfgCo' value='$row[MfgCo]'/>
                            <input type='hidden' name='MfgDate' value='$row[MfgDate]'/>
                            <input type='hidden' name='Exp' value='$row[Exp]'/>
    ...
    <table border=1>
        ...
        <tbody>
            <?php
             $jb_conn = mysqli_connect("localhost:3306", "root", "1234", "newcovid19db") or die("Error!!:: Covid-19 DataBase 접속 실패!!");
                $cnt_vac = "SELECT count(*) FROM vaccines LEFT OUTER JOIN vaccinate ON (vaccines.SerialNo = vaccinate.1st_Vno OR vaccines.SerialNo = vaccinate.2nd_Vno)
                            WHERE MfgCo = 'moderna' AND MfgDate <= CURDATE() AND Exp <= CURDATE() AND (1st_date IS NULL AND 2nd_date IS NULL)";
                $jb_result = mysqli_query( $jb_conn, $cnt_vac );
                $vac0 = mysqli_fetch_array($jb_result);
    ...
    <table border=1>
        ...
        <tbody>
            <?php
                $jb_conn = mysqli_connect("localhost:3306", "root", "1234", "newcovid19db") or die("Error!!:: Covid-19 DataBase 접속 실패!!");
                $cnt_vac = "SELECT count(*) FROM PRE_ORDERS WHERE MfgCo = 'moderna' AND MfgDate > CURDATE()";
                $jb_result = mysqli_query( $jb_conn, $cnt_vac );
                $vac0 = mysqli_fetch_array($jb_result);
    ...
    <table border=1>
        ...
        <tbody>
            <?php
                ...
                WHERE pre_orders.MfgCo = 'moderna' AND pre_orders.MfgDate > CURDATE()";
                $jb_result = mysqli_query( $jb_conn, $jb_sql );
                ...
                while($row = mysqli_fetch_array($jb_result)){
                    ...
                    echo "<TD>
                    <form action='M_Pre-order_edit.php' method='POST'>
                        <input type='hidden' name='SerialNo' value='$row[SerialNo]'/>
                        <input type='hidden' name='MfgCo' value='$row[MfgCo]'/>
                        <input type='hidden' name='MfgDate' value='$row[MfgDate]'/>
                        <input type='hidden' name='Exp' value='$row[Exp]'/>
                ...
                echo "<TD>
                    <form action='M_Pre-order_delete.php' method='POST'>
                        <input type='hidden' name='SerialNo' value='$row[SerialNo]'/>
                        <input type='hidden' name='uid' value='$username'/>
                        <button type='submit'>삭제</button>
                    </form>
    ...
    <!-- <table border=1>
        ...
        <tbody>
            <?php
                ...
                $cnt_vac = "SELECT count(*) FROM vaccines LEFT OUTER JOIN vaccinate ON (vaccines.SerialNo = vaccinate.1st_Vno OR vaccines.SerialNo = vaccinate.2nd_Vno) WHERE MfgCo = 'moderna'";
                $jb_result = mysqli_query( $jb_conn, $cnt_vac );
                $vac0 = mysqli_fetch_array($jb_result);
    ...
    <table border=1>
        ...
        <tbody>
            <?php
                /*$jb_conn = mysqli_connect("localhost", "root", "21720953", "newcovid19db") or die("Error!!:: Covid-19 DataBase 접속 실패!!");
                $jb_sql = "SELECT * FROM vaccines LEFT OUTER JOIN vaccinate ON (vaccines.SerialNo = vaccinate.1st_Vno OR vaccines.SerialNo = vaccinate.2nd_Vno) WHERE MfgCo = 'moderna' ORDER BY MfgDate ASC";
                $jb_result = mysqli_query( $jb_conn, $jb_sql );
